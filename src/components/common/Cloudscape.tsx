...
/**
 * Cloudscape — WebGL-powered animated cloud gradient.
 * Replaces the old CSS-layer cloud strips in SkyBackground with a soft,
 * continuously-morphing fbm cloud field rendered on the GPU.
 */
...
export default function Cloudscape({
  ...
  return (
    <div
      ref={hostRef}
      className={cn('relative flex w-full items-center justify-center overflow-hidden bg-sky-600', className)}
      style={{ height, ...style }}
      {...props}
    >
      <canvas
